...
public class UdemyCourse {
	...
	//Naive
	public static int MazeRatNaive(int i, int j, int m, int n, int[][]Maze){
		if(i < 0 || j < 0 || i == m || j == n) {
			return 0;
		}
		...
		return MazeRatNaive(i + 1, j, m, n, Maze) +
				MazeRatNaive(i, j + 1, m, n, Maze);
	}
	...
	//Optimized
	public static void Arrange2(int i, int n, int[]Array, int[]Basket){
		if(i == n){
			for(int l = 0; l < n; l++) {
	...
	public static void Arrange3(int i, int n,  int[]Basket){
		if(i == n){
			for(int l = 0; l < n; l++) {
