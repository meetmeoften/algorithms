...
public class RearrangeLinkedList {
	...
	public static LinkedList rearrangeLinkedList(LinkedList head, int k) {
		...
		LinkedListPair firstPair = connectLinkedList(smallerListHead, smallerListTail,
				equalListHead, equalListTail);
		LinkedListPair finalPair = connectLinkedList(firstPair.head, firstPair.tail,
	...
	public static LinkedListPair connectLinkedList(LinkedList headOne, LinkedList tailOne,
