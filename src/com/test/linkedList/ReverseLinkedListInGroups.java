...
//		int j=0;
//		ListNode len = head;
//		// loop for checking the length of the linklist, if the linklist is less then k, then return as it is.
//		while(j<k)
//		{
//			if(len == null ) {
//				return head;
...
//			i++;
//		}
//		// C1 is pointing to 1st node of K group, which is now going to point to the next K group linklist.
