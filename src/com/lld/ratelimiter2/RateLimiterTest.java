...
public class RateLimiterTest implements RateLimitListener {
	...
	// Inspect the TPS value in the prints and play around with this value. Increase
	// this value to avoid throttling
	private static long threshold_to_be_enforced = 100;
	// Sleep time between pumping traffic in milliseconds. Set to zero for
	// uncontrolled traffic ingestion.
	// Give a sleep time of 100 ms for example to pump traffic every 100
	// milliseconds and control the TPS
