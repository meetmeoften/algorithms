...
public class OpenLock {
	...
	public static int openLock(String[] deadends, String target) {
		...
		HashSet<String> visited = new HashSet<>();// visited set tro keep track of the node visited and to prevent
		// cycle
		...
		while (!q.isEmpty()) {// r m* w a*
			...
			while (size-- > 0) {
				...
				StringBuilder sb = new StringBuilder(temp);// using StringBuilder to modify the current string,
				// since it is mutable
				for (int i = 0; i < 4; i++) {
